...
import { validateQuestions } from './utils/questionUtils'
...
import { Screen01d } from './components/screens/01d_QuestionTimer'
import { Screen01e } from './components/screens/01e_Answer'
...
export default function App() {
  const { currentScreen, hydrate, setData, setValidationError, validationError, activePlayers, themes } = useGameStore()
  ...
  if (loading) {
    return (
      <div className="screen diagonal-bg" style={{ gap: 16 }}>
        ...
        <p style={{ fontFamily: 'var(--font-condensed)', color: 'var(--white-secondary)', fontSize: '0.9rem', letterSpacing: '0.1em' }}>
          Chargement…
        </p>
      </div>
    )
    ...
    return (
      <div className="screen diagonal-bg" style={{ gap: 20 }}>
        <div style={{
          ...
          border: '1.5px solid rgba(214,85,72,0.4)',
          background: 'rgba(214,85,72,0.08)',
          maxWidth: 520,
          textAlign: 'center',
        }}>
