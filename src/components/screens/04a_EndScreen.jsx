...
export function Screen04a() {
  ...
  const { playVictory, pauseAll, stopAll } = useAudio()
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {ranking.map((player, i) => (
              <div key={player} style={{
                ...
                <span style={{ fontFamily: 'var(--font-display)', fontSize: '1.6rem', color: i === 0 ? 'var(--yellow)' : 'var(--white-secondary)', minWidth: 36 }}>
                  {i + 1}
                </span>
